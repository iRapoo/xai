        ...
        for(int i = 1; i < 5; i++){
            ...
            if(json_t.equals(json_b))
                ...
                if(DATE.getWeekType() == 0)
                    rootView.findViewById(LIST.TOP(i + 7)).setBackgroundResource(R.drawable.less_now);
                else
                    rootView.findViewById(LIST.BOT(i + 7)).setBackgroundResource(R.drawable.less_now);
            }
