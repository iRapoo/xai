...
public class day5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.day5, container, false);
        ...
        for(int i = 1; i < 5; i++){
            ...
            final TextView TextView_t = rootView.findViewById(LIST.TOPt(i + 15));

            final String json_b = JSON.getJSON(context, "day4", i+"-1", group);
            final TextView TextView_b = rootView.findViewById(LIST.BOTt(i + 15));
            ...
            if(json_t.equals(json_b))
                rootView.findViewById(LIST.BOT(i+15)).setVisibility(View.GONE);
            else{
                if(DATE.getWeekType() == 0)
                    rootView.findViewById(LIST.TOP(i + 15)).setBackgroundResource(R.drawable.less_now);
                else
                    rootView.findViewById(LIST.BOT(i + 15)).setBackgroundResource(R.drawable.less_now);
            }
