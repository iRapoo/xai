...
public class ConfigClockActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Storage.emptyData(context, "S_GROUP")){
            AlertDialog.Builder builder = new AlertDialog.Builder(ConfigClockActivity.this);
        ...
        listGroup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                try {
                    ...
                    WidgetClock.updateWidget(context, appWidgetManager, sp, widgetID, remoteViews);
