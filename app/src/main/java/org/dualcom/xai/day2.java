...
public class day2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.day2, container, false);
        ...
        for(int i = 1; i < 5; i++){
            ...
            final TextView TextView_t = rootView.findViewById(LIST.TOPt(i+3));

            final String json_b = JSON.getJSON(context, "day1", i+"-1", group);
            final TextView TextView_b = rootView.findViewById(LIST.BOTt(i+3));
